...
import { StyleSheet, Text, View, Dimensions, TextInput, Button, Image, KeyboardAvoidingView, Pressable, TouchableWithoutFeedback, SafeAreaView} from 'react-native';
...
export default function Maps() {
  ...
  const filterMarker = (searchInput) => { 
    if (searchInput.length===0){setFilteredMarkers([])}
    else {
